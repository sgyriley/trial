        ...
        <div>
          <div className="flex flex-wrap justify-center">
            {values.map((value: any) => {
              ...
              return (
                <a href={'/categories/' + value.title} className="w-24 m-3">
                  <div>
                    <img
                      src={value.image.data.attributes.alternativeText}
                      alt=""
                      className="w-24 h-24 object-cover rounded-full"
                    />
                    <div className="font-bold mt-2 text-center">{value.title}</div>
                  </div>
                </a>
              );
            })}
