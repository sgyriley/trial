...
export const CategoryDetailPage = ({
  ...
  useEffect(() => {
    const v = Axios.get(
      `${process.env.REACT_APP_SERVER_URL}/lists?populate=*&filters[category][title][$eq]=${id}`,
      config
    )
      ...
      <BrowserRouter>
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {values.map((list: any) => {
            ...
            let category = list.category.data.attributes;
            let image = list.thumbnail.data.attributes;
            return (
              <>
                <div className="flex flex-col items-center justify-center w-full max-w-lg mx-auto">
                  ...
                  <p className="text-blue-500">{list.price}원</p>
                  ...
                  <button
                    ...
                    onClick={() => {
                      push('/message/' + list.Name); //chat --> message
                    }}
                  >
                    <svg
...
//                       className="flex items-center justify-center w-full px-2 py-2 mt-4 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-cyan-500 rounded-md hover:bg-cyan-600 focus:outline-none focus:bg-gray-700"
//                       onClick={function () {
//                         document.location.href = '/message/' + list.id;
//                       }}
//                     >
//                       <svg
//                         xmlns="http://www.w3.org/2000/svg"
